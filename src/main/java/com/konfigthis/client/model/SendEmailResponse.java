...
public class SendEmailResponse {
  ...
  public SendEmailResponse id(String id) {
  ...
  **/
   ...
   * @return the SendEmailResponse instance itself
   */
  public SendEmailResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, sendEmailResponse.id)&&
        Objects.equals(this.additionalProperties, sendEmailResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SendEmailResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SendEmailResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SendEmailResponse>() {
           ...
           public SendEmailResponse read(JsonReader in) throws IOException {
             ...
             SendEmailResponse instance = thisAdapter.fromJsonTree(jsonObj);
