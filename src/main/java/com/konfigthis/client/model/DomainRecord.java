...
public class DomainRecord {
  ...
  public DomainRecord record(String record) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The type of record.")
  ...
  **/
  ...
  public DomainRecord ttl(String ttl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The time to live for the record.")
  ...
  public DomainRecord status(String status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the record.")
  ...
  public DomainRecord value(String value) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The priority of the record.")
   ...
   * @return the DomainRecord instance itself
   */
  public DomainRecord putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.record, domainRecord.record) &&
        Objects.equals(this.name, domainRecord.name) &&
        Objects.equals(this.type, domainRecord.type) &&
        Objects.equals(this.ttl, domainRecord.ttl) &&
        Objects.equals(this.status, domainRecord.status) &&
        Objects.equals(this.value, domainRecord.value) &&
        Objects.equals(this.priority, domainRecord.priority)&&
        Objects.equals(this.additionalProperties, domainRecord.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(record, name, type, ttl, status, value, priority, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainRecord
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DomainRecord>() {
           ...
           public DomainRecord read(JsonReader in) throws IOException {
             ...
             DomainRecord instance = thisAdapter.fromJsonTree(jsonObj);
