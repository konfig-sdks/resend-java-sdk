...
public class CreateDomainRequest {
 ...
 public enum RegionEnum {
  ...
  private RegionEnum region = RegionEnum.US_EAST_1;
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The name of the domain you want to create.")
  ...
  public CreateDomainRequest region(RegionEnum region) {
  ...
  **/
  ...
  @ApiModelProperty(example = "US_EAST_1", value = "The region where emails will be sent from. Possible values are us-east-1' | 'eu-west-1' | 'sa-east-1")
   ...
   * @return the CreateDomainRequest instance itself
   */
  public CreateDomainRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createDomainRequest.name) &&
        ...
        Objects.equals(this.additionalProperties, createDomainRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, region, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateDomainRequest>() {
           ...
           public CreateDomainRequest read(JsonReader in) throws IOException {
             ...
             CreateDomainRequest instance = thisAdapter.fromJsonTree(jsonObj);
